...
const Companies = () => {
  ...
  return (
    <div className="w-full p-5">
      <h1 className="font-semibold text-3xl">All Companies</h1>
      <p className="text-xl mt-2">
        {data?.length > 0
          ? "Effortlessly access comprehensive company profiles."
          : "No Companies here"}
      </p>
      <div className="container mx-auto flex flex-col gap-5 2xl:gap-10 py-6 bg-[#f7fdfd]">
